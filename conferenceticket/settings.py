"""
Django settings for conferenceticket project.
...
SECRET_KEY = 'django-insecure-+4_ks=0di0-dkqvydrg9md+cs5lv8r8qg(xty^q@=$hnz*32s8'
...
ROOT_URLCONF = 'conferenceticket.urls'
...
WSGI_APPLICATION = 'conferenceticket.wsgi.application'
